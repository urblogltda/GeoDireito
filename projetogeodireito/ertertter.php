...
<body id="page-instrucoes">
    ...
    <div class="mt-5 mb-5">
        <div class="mb-5 text-center">
            <h1 id="titulohtml">ertertter</h1>
            <h6 id="subtitulohtml">ertertert</h6>
        </div>
        <div class="text-center"><img src="imagesmanual/ertertter.4216177c3c062abef8cebc718038521d.jpg" height="450px" class="img-fluid" alt="Responsive image"></div>
        <div id="content">
            <p>ertertet</p>
        </div>
    </div>
