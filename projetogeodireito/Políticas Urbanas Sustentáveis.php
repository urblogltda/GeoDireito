...
<body id="page-instrucoes">
    ...
    <div class="mt-5 mb-5">
        <div class="mb-5 text-center">
            <h1 id="titulohtml">Políticas Urbanas Sustentáveis</h1>
            <h6 id="subtitulohtml"></h6>
        </div>
        <div id="content">
            <p>As políticas urbanas fazem parte do desenvolvimento e crescimento de um lugar, para isso, porém, é necessário que se atente às necessidades sociais, ecológicas e a realidade local.&nbsp;</p>
        </div>
    </div>
    </div>
</body>
