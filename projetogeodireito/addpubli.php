...
fclose($myfile);
/*-------LICENCIAMENTO-------------------------LICENCIAMENTO-----------------------LICENCIAMENTO-------------------------*/
$sql = "INSERT INTO projetos.editorpublicacoes
   (titulo, subtitulo, datacadastro,capapublicacao, criadopor)
   VALUES
   (:titulo, :subtitulo,:datacadastro,:capapublicacao, :criadopor);";
...
$stmt->bindValue(':capapublicacao', $arquivo_nomeimageprojeto);
