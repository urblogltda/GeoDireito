...
<body id="page-instrucoes">
    ...
    <div class="mt-5 mb-5">
        <div class="mb-5 text-center">
            <h1 id="titulohtml">Alternativa de Saneamento na Lagoa da Conceição</h1>
            <h6 id="subtitulohtml"></h6>
        </div>
        <div id="content">
            <p>Atualmente, o sistema de saneamento na Lagoa da Conceição é precário. Necessário se pensar alternativas.</p>
        </div>
    </div>
    </div>
</body>
            ...
            <div class="modal-body">
                ...
                <input type="text" id="oldtitle" class="form-control" id="recipient-name" name="oldtitle" autocomplete="off" hidden>
                    ...
                    <div id="filediv" class="form-group">
                        ...
                        <input accept="image/*" id="noticiaimagem" type="file" id="image" name="noticiaimagem" />
                    </div>
                </form>
                <div id="forminsert">
