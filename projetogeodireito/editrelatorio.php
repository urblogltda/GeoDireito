...
if ($imageprojeto["name"] != "") {
    ...
    $sql = "UPDATE projetos.editorrelatorio

    SET titulo='$titulo', subtitulo='$descini', dataupdate='$data_cadastro', caparelatorio='$arquivo_nomeimageprojeto' where titulo='$oldtitle';";
                    ...
                    $.ajax({
                        ...
                        success: function(msg) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.replace("https://urbanlogics.com.br/urb/projetogeodireito/relatorios.php");
                                }
                            });
                        },
                        cache: false,
