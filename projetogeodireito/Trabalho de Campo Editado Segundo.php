...
<body id="page-instrucoes">
    ...
    <div class="mt-5 mb-5">
        <div class="mb-5 text-center">
            <h1 id="titulohtml">Trabalho de Campo Editado Segundo</h1>
            <h6 id="subtitulohtml">Trabalho de Campo Editado Segundo</h6>
        </div>
        <div id="content">
            <p style="margin-left:0px;text-align:center;">Trabalho de Campo Editado Segundo</p>
        </div>
    </div>
    </div>
</body>
