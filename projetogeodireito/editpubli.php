...
if ($imageprojeto["name"] != "") {
    ...
    $sql = "UPDATE projetos.editorpublicacoes

    SET titulo='$titulo', subtitulo='$descini', dataupdate='$data_cadastro', capapublicacao='$arquivo_nomeimageprojeto' where titulo='$oldtitle';";
