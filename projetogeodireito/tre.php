...
<body id="page-instrucoes">
    ...
    <div class="mt-5 mb-5">
        <div class="mb-5 text-center">
            <h1 id="titulohtml">tre</h1>
            <h6 id="subtitulohtml">ter</h6>
        </div>
        <div class="text-center"><img src="imagesmanual/tre.ddf1ee46b89e67945f7512e90517eaf8.jpg" height="450px" class="img-fluid" alt="Responsive image"></div>
        <div id="content">
            <p>etr</p>
        </div>
    </div>
