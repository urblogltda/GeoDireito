...
if ($imageprojeto["name"] != "") {
    ...
    $path = 'public_html/urb/projetogeodireito/imagesconteudo/';
    ...
    $sql = "UPDATE projetos.editortrabalho

    SET titulo='$titulo', subtitulo='$descini', dataupdate='$data_cadastro', capatrabalho='$arquivo_nomeimageprojeto' where titulo='$oldtitle';";
...
SET titulo='$titulo', subtitulo='$descini', dataupdate='$data_cadastro' where titulo='$oldtitle';";
var_dump($sql);
    $stmt = $conn->prepare($sql);
                    ...
                    $.ajax({
                        ...
                        success: function(msg) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.replace("https://urbanlogics.com.br/urb/projetogeodireito/trabalhos.php");
                                }
                            });
                        },
                        cache: false,
