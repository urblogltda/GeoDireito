...
if (!isset($_FILES['noticiaimagemedit'])) {
    exit('Nenhum arquivo enviado! Upload Manual');
}

$noticiaimagem = $_FILES['noticiaimagemedit'];
...
$sql = "UPDATE projetos.noticias

SET titulo='$titulo', subtitulo='$descini', dataupdate='$data_cadastro', capanoticia='$arquivo_nomenoticiaimagem' where titulo='$oldtitle';";
