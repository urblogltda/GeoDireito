      ...
      getDblClickHandler: function(e){
          ...
          var workspace = this.layer,
              ...
              html = [
                  ...
                  '  <svg class="projetogeodireitomeasure" viewbox="0 0 45 35">',
                  '   <path style="stroke: '+this.options.contrastingColor+'" class="projetogeodireito" d="M 10,10 L 30,30 M 30,10 L 10,30" />',
                  '  </svg>',
                  '</div>'
              ].join('');
          ...
          var fireSelected = function(e){
              if(L.DomUtil.hasClass(e.originalEvent.target, 'projetogeodireito')){
