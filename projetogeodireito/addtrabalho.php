...
fclose($myfile);
/*-------LICENCIAMENTO-------------------------LICENCIAMENTO-----------------------LICENCIAMENTO-------------------------*/
$sql = "INSERT INTO projetos.editortrabalho
   (titulo, subtitulo, datacadastro,capatrabalho, criadopor)
   VALUES
   (:titulo, :subtitulo,:datacadastro,:capatrabalho, :criadopor);";
$stmt = $conn->prepare($sql);
$stmt->bindValue(':titulo', $titulo);
$stmt->bindValue(':subtitulo', $descini);
$stmt->bindValue(':datacadastro', $data_cadastro);
$stmt->bindValue(':capatrabalho', $arquivo_nomeimageprojeto);
$stmt->bindValue(':criadopor', $user);
$stmt->execute();
$count = $stmt->rowCount();
?>
